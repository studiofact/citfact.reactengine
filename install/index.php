...
class citfact_reactengine extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.reactengine';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('REACT_ENGINE_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('REACT_ENGINE_MODULE_DESCRIPTION');
