...
$allOptions = array(
    array('REACT_SOURCE', Loc::getMessage('REACT_ENGINE_LIBRARY_PATH'), '', array('text', 40)),
    array('APP_SOURCE', Loc::getMessage('REACT_ENGINE_APP_PATH'), '', array('text', 40)),
);

$controlTabs = array(array(
    'DIV' => 'tab-settings',
    'TAB' => Loc::getMessage('REACT_ENGINE_TAB'),
    'TITLE' => Loc::getMessage('REACT_ENGINE_TAB_TITLE'),
));
